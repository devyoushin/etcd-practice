...
| `/review-doc` | 문서 검토 | `/review-doc docs/04-backup-restore/backup-guide.md` |
...
| 문서 | 주제 |
|------|------|
| `docs/01-installation/install.md` | etcd 설치 (Docker Compose / systemd) |
| `docs/02-architecture/architecture-guide.md` | etcd 아키텍처 (Raft, WAL) |
| `docs/06-operations/basic-operations-guide.md` | 기본 CRUD 및 Watch |
| `docs/03-cluster/cluster-guide.md` | 3노드 클러스터 구성 |
| `docs/06-operations/ha-guide.md` | 5노드 HA 클러스터 |
| `docs/04-backup-restore/backup-guide.md` | 스냅샷 백업/복구 |
| `docs/07-troubleshooting/troubleshooting-guide.md` | 트러블슈팅 |
| `docs/05-kubernetes/kube-apiserver-etcd-storage-guide.md` | kube-apiserver → etcd 요청 흐름 및 Key 저장 구조 |
| `docs/05-kubernetes/k8s-etcd-ops-guide.md` | 대규모 온프레미스 k8s 환경 etcd 이슈 대응 가이드 |
